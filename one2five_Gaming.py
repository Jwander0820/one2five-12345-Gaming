...
class GAME12345(object):
    ...
    def AdvanceRule(self):
        ...
        for i in range(3):  # 三局制
            enemy_deck, player_deck, result, Match_point = GAME12345().Advanceloop(enemy_deck, player_deck, result,
                                                                                   Match_point)
            if result[0] == 2:
                print('你輸了QQ')
                break
    ...
    def AdvanceRule_Autotest(self):
        ...
        for i in range(3):  # 三局制
            enemy_deck, player_deck, result, Match_point = GAME12345().Advanceloop_Autotest(enemy_deck, player_deck,
                                                                                            result, Match_point)
